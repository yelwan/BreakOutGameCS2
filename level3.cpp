#include "level3.h" // Include the corresponding header file
#include <typeinfo> // Include necessary header files

Level3::Level3(QObject* parent) : QObject(parent) // Constructor definition with QObject pointer as a parameter
{
    ...
    connect(this, &Level3::levelCompleteSignal, this, &Level3::onLevelComplete); // Connect the level complete signal to its slot
}

void Level3::setLevel() // Definition of the function to set up the level
{
...
bool Level3::levelComplete() // Definition of the function to check if the level is complete
{
...
void Level3::nextLevel() // Definition of the function to transition to the next level
{
    scene.clear(); // Clear the scene
    Level4* level4 = new Level4(); // Create a new Level4 object
}

void Level3::onLevelComplete() // Definition of the function to handle level completion
{
