#include "level4.h" // Include the corresponding header file
#include <typeinfo> // Include necessary header files

Level4::Level4(QObject* parent) : QObject(parent) // Constructor definition with QObject pointer as a parameter
{
    ...
    connect(this, &Level4::levelCompleteSignal, this, &Level4::onLevelComplete); // Connect the level complete signal to its slot
}

void Level4::setLevel() // Definition of the function to set up the level
{
...
bool Level4::levelComplete() // Definition of the function to check if the level is complete
{
...
void Level4::nextLevel() // Definition of the function to transition to the next level
{
    scene.clear(); // Clear the scene
    Level5* level5 = new Level5(); // Create a new Level5 object
    level5->setLevel(); // Set up the level
}

void Level4::onLevelComplete() // Definition of the function to handle level completion
{
